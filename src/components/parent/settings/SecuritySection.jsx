...
export default function SecuritySection({ profile, onShowSuccess }) {
  ...
  return (
    <SectionCard icon={Lock} colorClass="text-red-400" title="Sécurité Parent">
      <div className="flex gap-3 items-end">
        <div className="flex-1">
          <label className="text-[9px] text-slate-500 uppercase font-black ml-1">Modifier le code PIN</label>
          <input 
            type="tel" 
            maxLength={4}
            placeholder="••••"
